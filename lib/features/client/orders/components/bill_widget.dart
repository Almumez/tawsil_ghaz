    ...
    return Row(
      children: [
        Expanded(
          child: Text(
            title,
            style: isBold ? context.boldText.copyWith(fontSize: 14) : context.regularText.copyWith(fontSize: 14),
          ),
        ),
        Text.rich(
          TextSpan(children: [
            TextSpan(text: "$value", style: context.boldText.copyWith(fontSize: 16)),
